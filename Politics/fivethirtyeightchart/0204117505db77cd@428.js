...
Data Sources: [polls](https://projects.fivethirtyeight.com/trump-approval-data/approval_polllist.csv), [trend lines](https://projects.fivethirtyeight.com/trump-approval-data/approval_topline.csv)<br/>
  ...
  main.variable(observer("trends")).define("trends", ["d3"], function(d3) {
    return (
  ...
  main.variable(observer("React")).define("React", ["require"], function(require) {
    return (
      require("https://bundle.run/react")
    )
  });
  main.variable(observer("ReactDOM")).define("ReactDOM", ["require"], function(require) {
    return (
      require("https://bundle.run/react-dom")
    )
  });
  main.variable(observer("Scale")).define("Scale", ["require"], function(require) {
    return (
      require("https://bundle.run/@vx/scale@0.0.161")
    )
  });
  main.variable(observer("Axis")).define("Axis", ["require"], function(require) {
    return (
      require("https://bundle.run/@vx/axis@0.0.162 ")
    )
  });
  main.variable(observer("Group")).define("Group", ["require"], function(require) {
    return (
      require("https://bundle.run/@vx/group@0.0.161")
    )
  });
  main.variable(observer("Curve")).define("Curve", ["require"], function(require) {
    return (
      require("https://bundle.run/@vx/curve@0.0.161")
    )
  });
  main.variable(observer("Shape")).define("Shape", ["require"], function(require) {
    return (
      require("https://bundle.run/@vx/shape@0.0.162")
    )
  });
  main.variable(observer("Grid")).define("Grid", ["require"], function(require) {
    return (
